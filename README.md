...
- [NullSec Linux Forensics Edition](https://github.com/bad-antics/nullsec-linux) - Debian-based forensics distribution with 135+ tools including specialized forensics, memory analysis, and timeline tools
